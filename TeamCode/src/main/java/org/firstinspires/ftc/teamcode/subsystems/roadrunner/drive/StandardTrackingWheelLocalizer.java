...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13.52; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 5.5; // in; offset of the lateral wheel
    public static double X_MULTIPLIER = -1.02302846491;
    public static double Y_MULTIPLIER = 1.02276622987;
